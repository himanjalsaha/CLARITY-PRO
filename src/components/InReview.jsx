...
export function InReview() {
    ...
    return <div>
        <div>
            <div className="flex flex-row justify-between bg-green-200 rounded-lg py-1 items-center mt-8">
                <div className="flex flex-row px-4 gap-4  items-center">
                    ...
                    <span className="text-xl font-semibold text-green-800">In Review</span>
