  ...
  return (
    <div className="  h-screen flex flex-row  p-5 gap-10">
      <div className=" flex-[0.49] flex items-center justify-center">
        <img src={blob} alt="" className=" absolute w-[45%] " />
        <img
          src={img}
          alt=""
          className=" relative rounded-2xl  h-[56%] w-[56%]"
        />
      </div>
      <div className=" flex-[0.6] flex justify-center items-center flex-col">
        ...
        <text className="text-white  text-xl m-8">
          ~Elevate productivity with intelligent task management, collaboration,
          and AI-driven insights. Your path to streamlined workflows and
          success.
        </text>
      </div>
    </div>
