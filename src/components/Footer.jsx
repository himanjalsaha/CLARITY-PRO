export function Footer() {
  return (
      <div className="flex items-center flex-col justify-center bg-neutral-900 text-center text-white">
            <div className="flex gap-40  justify-center text-gray-400 font-semibold">
              <span>Clarity Pro</span>
              <span>About Us</span>
          ...
          <div className="w-full p-4 text-center bg-opacity-20 bg-neutral-800 text-white">
        © 2023 Copyright :
